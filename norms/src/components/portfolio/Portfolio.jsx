...
export const projectData = [
  {
    ...
    paragraph: "From what I observed so far, I noticed that they are correlated to some companies that I recognize which I didnt know. Vitro on the other hand is a company that own and handle components for a data center. When I went through their data center, it was filled with security measures such as biometric scanners, CCTV cameras, and security personnel to ensure the safety and integrity of the data stored within their servers. They also own UPS systems to provide backup power in case of electrical outages, ensuring continuous operation of their data center.",
    paragraph2: "The PLDT have their own databases and servers to handle their services. The difference between their data center and cloud services is that PLDT is for internet providers while Vitro is for businesses and companies that need data storage and management. Vitro Data Center also has multiple branches that is away from high risk hazards or disaster, which made them prepared and cautious about their data center operations. Overall, the tour provided valuable insights into the telecommunications industry and the critical role that data centers play in supporting modern communication networks.",
    link: "#!",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    paragraph: "I thought its an emergency response center that only handle 911 calls. But when I entered the center, I saw that they have a very organized and clean working space. Their workstations are equipped with multiple monitors and technologies. I have also noticed that they have a big screen that shows the live CCTV footage around the city which helps them monitor any weather status, disasters or incidents in real-time. They also have a seismology monitoring system that tracks earthquake activities in the region.",
    paragraph2: "They also handle non-emergency calls such as traffic updates, public inquiries, and community assistance requests. They have additional responders for each areas that is vulnerable to disasters. They have a reserved vehicle that has all the same equipments just incase their center gets in disaster as well so that they will still be able to take action, report and respond to emergencies.",
  },
  {
    id: 4,
    image: card4,
    ...
    description: "Awarded for successfully completing the Davao Educational Tour, demonstrating active participation and engagement in learning about local industries and culture.",
...
const Portfolio = () => {
  return (
    <div
      ...
      id="portfolio"
    >
      <div className="xl:mb-17.5 mb-5" data-aos="fade-up">
